...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/movie_on1"),
                InlineKeyboardButton(" Update ⭕️", url="https://t.me/movie_a1")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/movie_on1'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/movie_a1')
            ],
            [
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/movie_a1')
            ]
            ]
        await query.answer()
        await client.send_cached_media(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/movie_a1'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/movie_on1')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/movie_a1'),
